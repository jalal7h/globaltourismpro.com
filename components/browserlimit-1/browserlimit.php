...
$GLOBALS['do_init'][] = 'browserlimit';

function browserlimit(){
    
    if( browserlimit == false ){
        return true;
    ...
    if( $down ){
        echo template_engine('browserlimit',$vars);
        die();
    }
...
function browserInfo(){
    $browser = new Browser();
    return array("browser"=>$browser->getBrowser() ,"version"=>$browser->getVersion());
}
