...
--
-- Host: localhost
-- Generation Time: May 03, 2017 at 01:01 AM
...
(34, 'What is Daily Tour', '{_URL}/What-is-DailyTour', '', 1, 0, 0, '5', 0),
(35, 'Details about the Transfer service', '{_URL}/Details-about-the-Transfer-service', '', 1, 0, 0, '5', 0),
(36, 'All about the Visa', '{_URL}/All-about-the-Visa', '', 1, 0, 0, '5', 0);
...
INSERT INTO `mg_transfer` (`id`, `name`, `position_id`, `transferBasis_id`, `tariff`, `itinerary`, `conditions`, `notes`, `vehicle_id`, `drivernumber`, `date_from`, `date_to`, `deathline`, `reservation`, `flag`, `date_created`, `date_updated`, `hide`) VALUES
...
(1, 1, 2, 'postlist', 'HTML', 'Last posts', 0, 'gallery', 1, '', 1),
(111, 1, 0, 'mg_searchbox', 'HTML', 'Search box', 0, '', 1, '', 1),
(8, 8, 1, 'postlist', '', 'List of posts', 0, 'blog', 1, '', 1),
...
INSERT INTO `post` (`id`, `name`, `slug`, `text`, `cat`, `flag`, `date_created`, `hide`) VALUES
...
INSERT INTO `user` (`id`, `email`, `email_verified`, `password`, `permission`, `name`, `wallet_credit`, `cell`, `cell_verified`, `tell`, `address`, `profile_pic`, `im_a`, `work_at`, `gender`, `offrate`, `management_title`, `useronline_date`, `flag`, `hide`, `register_ip`, `register_date`, `login_ip`, `login_date`) VALUES
(1, 'ogun@karisma.co.tr', 1, '9bb3da7992db2e95708e77be0a3f8938', 2, 'Ogün Özbir', 0, '902123820942', 0, '', '1000000', '', '', '', '', 0, '', 1493757064, 0, 0, '', 0, '', 0),
(2, 'jalal7h@gmail.com', 1, '3360@met', 0, 'Edmond Koligof', 0, '+909128844331', 0, '', '', 'data/user_profile_pic/2/0-1493675489-me-on-niak.jpg', '999', '', 'M', 3.01, '', 1493753393, 1, 0, '', 0, '', 0),
(3, 'monja@mohta.ba', 1, '1949b7308f936aa179af4cad5238f9ba', 2, 'Konjale Mohtaba', 0, '+90444332954384', 0, '', '', '', '', '', '', 0, 'Billing Management', 1480803837, 1, 0, '', 0, '', 0);
...
--
ALTER TABLE `billing_invoice`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'شناسه', AUTO_INCREMENT=38;
--
